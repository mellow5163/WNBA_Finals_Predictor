...
This program uses logistic regression to predict the winner of the WNBA Finals based on data from the 2023 WNBA regular season. This model is built using Python, pandas, and sci-kit learn.
...
To make a prediction, run the script using Python. The home team and away team can be changed by modifying the script. The script outputs a prediction of either 1.0 (home team wins) or 0.0 (away team wins), as well as the average accuracy of the model.
